...
namespace EzySlice
{
    ...
    public sealed class Slicer
    {
         ...
         */
        public static SlicedHull Slice(GameObject obj, Plane pl, TextureRegion crossRegion, Material crossMaterial, bool intersectionOnly=false)
        {
            ...
            return Slice(mesh, pl, crossRegion, crossIndex, intersectionOnly);
        }
        ...
        private static Mesh CreateHull(SlicedSubmesh[] meshes, int total, List<Triangle> crossSection, int crossIndex, bool isUpper)
        {
            ...
            newMesh.triangles = triangles.ToArray()[0];
            // add the submeshes
            /*
